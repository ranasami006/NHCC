                ...
                <View style={styles.container}>
                    ...
                    <ImageBackground source={require('../assets/Background.png')} style={{ height: '100%', width: '100%' }}>
                        <ScrollView>
                            ...
                            <Text style={{ alignSelf: 'center', color: 'white', fontWeight: '700', fontSize: 24, lineHeight: 36, marginTop: responsiveHeight(5) }}>
                                NHCC Ticketing System
           </Text>
                            <Text style={{
                          ...
                          <Text style={{ alignSelf: 'center', color: 'white', fontWeight: '600', fontSize: 16, lineHeight: 28}}>
                            ...
                            <TouchableOpacity style={styles.profileBtn}onPress={()=>{this.props.navigation.navigate('Profile')}}>
                          <Text style={{ alignSelf: 'center', color: 'white', fontWeight: '600', fontSize: 16, lineHeight: 28}}>
                          Create Profile
                          </Text>
                            </TouchableOpacity>  
